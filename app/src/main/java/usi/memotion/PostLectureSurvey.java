...
public class PostLectureSurvey {
    ...
    public PostLectureSurvey(Double timestamp, String q1, String q2, String q3){
    ...
    public Double getTimestamp(){return this._timestamp;}

    public String get_question1(){return this._question1;}

    public String get_question2(){return this._question2;}
